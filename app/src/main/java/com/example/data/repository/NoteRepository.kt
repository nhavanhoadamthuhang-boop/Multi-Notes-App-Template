...
class NoteRepository(
    ...
    val archivedComments: Flow<List<CommentEntity>> = commentDao.getArchivedComments()
    ...
    suspend fun updateNoteImageUri(id: Long, imageUri: String?) {
        noteDao.updateNoteImageUri(id, imageUri)
    }
    ...
    suspend fun toggleNoteBookmarked(id: Long, currentBookmarked: Boolean) {
        noteDao.updateNoteBookmarked(id, !currentBookmarked)
    }
    ...
    suspend fun toggleCommentBookmarked(id: Long, currentBookmarked: Boolean) {
        commentDao.updateCommentBookmarked(id, !currentBookmarked)
    }
    ...
    suspend fun updateComment(
        ...
        commentDao.updateCommentDetails(
            id = id,
            content = content.trim(),
            authorName = authorName.ifBlank { "Đàm Tường Quân" },
            avatarType = avatarType,
    ...
    suspend fun updateCommentImageUri(id: Long, imageUri: String?) {
        commentDao.updateCommentImageUri(id, imageUri)
    }
    ...
    suspend fun importBackupData(backupData: BackupData, replaceExisting: Boolean): ImportSummary {
        ...
        for (backupNote in backupData.notes) {
            val noteEntity = NoteEntity(
                ...
                isBookmarked = backupNote.isBookmarked,
            ...
            for (rootComment in rootComments) {
                val commentEntity = CommentEntity(
                    ...
                    isBookmarked = rootComment.isBookmarked,
                    createdAt = rootComment.createdAt,
                    avatarType = rootComment.avatarType,
                    avatarValue = rootComment.avatarValue,
                    avatarBgColor = rootComment.avatarBgColor,
                    imageUri = rootComment.imageUri
                )
    ...
    suspend fun toggleCommentArchived(comment: CommentEntity) {
        commentDao.updateComment(comment.copy(isArchived = !comment.isArchived))
    }
}
