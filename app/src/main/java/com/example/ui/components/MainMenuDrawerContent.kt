...
fun MainMenuDrawerContent(
    ...
    onOpenManageLabels: () -> Unit = {},
    onOpenImportPdfUrl: () -> Unit = {},
    ...
    ModalDrawerSheet(
        ...
        Column(
            ...
            // Leaderboard
            NavigationDrawerItem(
                label = { Text("Bảng Xếp Hạng Kim Cương") },
                selected = false,
                onClick = {
                    onCloseDrawer()
                    onOpenLeaderboard()
                ...
                modifier = Modifier
                    .padding(NavigationDrawerItemDefaults.ItemPadding)
                    .testTag("menu_nav_leaderboard")
            )

            // Manage Labels
            NavigationDrawerItem(
                label = { Text("Tạo & Quản lý Nhãn") },
                selected = false,
                onClick = {
                    onCloseDrawer()
                    onOpenManageLabels()
                ...
                modifier = Modifier
                    .padding(NavigationDrawerItemDefaults.ItemPadding)
                    .testTag("menu_nav_manage_labels")
            )
            ...
            // Nhập từ PDF & URL
            NavigationDrawerItem(
                label = { Text("Nhập tệp PDF & URL Web") },
                selected = false,
                onClick = {
                    onCloseDrawer()
                    onOpenImportPdfUrl()
            ...
            NavigationDrawerItem(
                ...
                modifier = Modifier
                    .padding(NavigationDrawerItemDefaults.ItemPadding)
                    .testTag("menu_nav_travel_samples")
            )

            // Multi-format Import / Export
            NavigationDrawerItem(
                label = { Text("Nhập/xuất tệp tin đa định dạng") },
                selected = false,
                onClick = {
                    onCloseDrawer()
                    onOpenJsonBackup()
