...
class JsonBackupTest {
    ...
    fun exportAndParseAllNotes_roundTripSucceeds() {
        ...
        val comments = listOf(
            CommentEntity(id = 10, noteId = 1, parentId = null, authorName = "Đàm Tường Quân", content = "Bình luận gốc"),
            CommentEntity(id = 11, noteId = 1, parentId = 10, authorName = "Lương Thuỷ Tiên", replyToAuthor = "Đàm Tường Quân", content = "Phản hồi cho Đàm Tường Quân")
        )
        ...
        assertTrue(jsonString.contains("Phản hồi cho Đàm Tường Quân"))
        ...
        assertEquals("Đàm Tường Quân", note1.comments[0].authorName)
        assertEquals("Lương Thuỷ Tiên", note1.comments[1].authorName)
